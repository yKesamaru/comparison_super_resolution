...
## 元画像
![](assets/tmp/processed_1.png)
![](assets/tmp/processed_2.png)
![](assets/tmp/processed_3.png)
![](assets/tmp/processed_4.png)
...
というのは、おそらくデータセットに存在した顔の特徴を、他の顔にも適用しているからだと思います。
